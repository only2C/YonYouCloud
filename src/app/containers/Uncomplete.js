...
class Uncomplete extends React.Component {
    ...
    componentDidMount() {
     ...
     updateCurrentQuery() {
         ...
         this.refs.portalquery.initPortalBillType('false');
    ...
    render() {
        return (
            <div className="portal-table-header">
                <PortalQuery ref ="portalquery" index="0" pageSize={this.state.pageSize} isHasComplete="false" isHasCompletePortlet="false"  onQuery={this.query} queryUrl={Config.portal.billQueryUrl}/>
                ...
                <PortalPage ref="page" pageId="uncompletePage"  page={this.state.pageStatus} onSpecifiedPageSize={this.specifiedPageSize} onSelect={index => this.goPage(index)} />
